...
class GreenTree extends Plant {
    constructor({ position, offset = { x: 10, y: 65 }, behaviorKey = E_behaviors.IDLE, angelKey = E_angels.ANGEL_0, opacity = 1, fruitingDuration = 1000, placementTile, spawGemPerTime = 2, }) {
